...
public class BoosterCommand extends CommandManager {
    ...
    public TabCompletion getTabCompletion() {
        return new BoosterTab();
    }

    public static class BoosterTab extends TabCompletion {

        public BoosterTab() {
            super("booster",
                    new TabBuilder()
                            .addTab(new Tab().arg(1).addVariant("debug").addVariant("stop")
                                    .addVariant("money").addVariant("blocks"))
                            .getResult(),
                    "prison.admin");
        }
    }
