...
public class MainMenu implements IMenus {
    ...
    public static void load() {
        try {
            ...
            IMenuButton achievs = DefaultButtons.FILLER.getButtonOfItemStack(new Item.Builder(Material.MINECART)
                    .name("&aДостижения")
                    .lore(new Lore.BuilderLore()
                            .addSpace()
                            .addString("&7>> Открыть меню").build()).build().item())
            ...
            IMenuButton rebirth = DefaultButtons.FILLER.getButtonOfItemStack(new Item.Builder(Material.ENDER_EYE)
            ...
            IMenuButton mines = DefaultButtons.FILLER.getButtonOfItemStack(new Item.Builder(Material.GRASS_BLOCK)
                    .name("&aЛокации")
                    .lore(new Lore.BuilderLore()
                            .addSpace()
                            .addString("&7>> Открыть меню").build()).build().item())
            ...
            IMenuButton blocks = DefaultButtons.FILLER.getButtonOfItemStack(new Item.Builder(Material.BIRCH_SIGN)
            ...
            IMenuButton spawn = DefaultButtons.FILLER.getButtonOfItemStack(new Item.Builder(Material.SUNFLOWER)
