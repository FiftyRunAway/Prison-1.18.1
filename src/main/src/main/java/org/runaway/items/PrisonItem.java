...
public class PrisonItem {
    ...
    public enum Category {
        ...
        QUEST("&bКвест", new ItemStack(Material.WRITABLE_BOOK)),
        UPGRADES("&2Улучшения", new ItemStack(Material.FIREWORK_ROCKET)),
        ...
        EXP("&6Опыт", new ItemStack(Material.EXPERIENCE_BOTTLE), true),
