...
public enum Privs {
    ...
    }, 2, Material.ORANGE_DYE, "&7Привилегия: &aVIP", 10, 150),
   PREMIUM("prison.premium", new IFeature[] {
    ...
    }, 3, Material.YELLOW_DYE, "&7Привилегия: &bPremium", 11, 200),
    ...
    }, 4, Material.LIGHT_BLUE_DYE, "&7Привилегия: &bCrystal", 12, 300),
    ...
    }, 5, Material.LIME_DYE, "&7Привилегия: &aLord", 13, 450),
    ...
    }, 6, Material.RED_DYE, "&7Привилегия: &cMagma", 14, 550),
    JUNIOR("prison.junior", new IFeature[] {
            ...
            new BossNotify().setValue(true)
    }, 7, Material.PURPLE_DYE, "&7Привилегия: &dJunior", 15, 750),;
